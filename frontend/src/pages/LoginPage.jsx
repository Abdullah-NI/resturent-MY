...
import { LogIn, Mail, Lock, Sparkles, UtensilsCrossed } from 'lucide-react';
  ...
  return (
    <div className="pt-28 pb-20 max-w-md mx-auto px-4 space-y-8">
      <div className="text-center space-y-3">
        ...
        <p className="text-xs text-zinc-600 dark:text-zinc-400">Sign in to manage your orders, reservations, and profile</p>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900/90 border border-zinc-200 dark:border-gold-500/20 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl dark:shadow-2xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <Link to="/forgot-password" className="text-[11px] text-burgundy-800 dark:text-gold-400 hover:underline">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
        ...
        <div className="text-center text-xs text-zinc-600 dark:text-zinc-400 pt-2 border-t border-zinc-100 dark:border-zinc-800">
          ...
          <Link to="/register" className="text-burgundy-800 dark:text-gold-400 font-bold hover:underline">
            Register now
          </Link>
        </div>
      </div>
